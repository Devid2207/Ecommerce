                                ...
                                <div class="dokan-booking-general-details">
                                    <ul class="list-unstyled booking-status">
                                        ...
                                        <li>
                                            ...
                                            ?>
                                            <?php echo esc_url( "<a href='" . $product_url . "'>" . esc_html( $product->get_title() ) . '</a>' ); ?>
                                        </li>
                                        ...
                                        <li>
                                            ...
                                            <?php echo $product->get_duration() . ' ' . \WeDevs\DokanPro\Modules\Booking\Module::get_booking_duration_unit_label( $product->get_duration_unit() ); ?>
                                        </li>
                                    </ul>
                                </div>
                            </div>
